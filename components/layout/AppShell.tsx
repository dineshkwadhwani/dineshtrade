          ...
          <div className="relative" ref={menuRef}>
            ...
            {menuOpen && (
              <div role="menu"
                ...
                {/* Identity */}
                <div className="px-3 py-2.5 border-b" style={{ borderColor: 'var(--dt-border)' }}>
                ...
                <div className="py-1">
                  {NAV_GROUPS.map(group => (
                    <div key={group.title} className="px-1 pb-1 last:pb-0">
                      <p className="px-2 pb-1 text-[8px] tracking-[0.22em] uppercase"
                        ...
                        {group.items.map(item => {
                          ...
                          return (
                            <Link key={item.href} href={item.href} role="menuitem"
                              className="flex items-center justify-between gap-2 px-2.5 py-2 text-[11px] transition-all"
                              style={{
                ...
                <button onClick={handleLogout} role="menuitem"
                  className="w-full flex items-center gap-2 px-2.5 py-2 text-[11px] transition-all text-left border-t"
